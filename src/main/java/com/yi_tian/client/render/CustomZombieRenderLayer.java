...
public class CustomZombieRenderLayer extends FeatureRenderer<ZombieEntity, ZombieEntityModel<ZombieEntity>> {
    public static final TrackedData<Boolean> LOYAL= DataTracker.registerData(ZombieEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    @Override
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, ZombieEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
